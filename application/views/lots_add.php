        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Add Lot </h4>
                </div>
                <div class="card-body">
                    <form action="<?php echo base_url('lots/insert'); ?>" method="post">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="tract_id" required="">
                                    ...
                                    <?php foreach ($data_tract as $row_tract) { ?>
                                        <option value="<?php echo $row_tract->id; ?>"><?php echo $row_tract->tract_no; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="lot_no" required="" onkeypress="return isNumberKey(event)">
                            </div>
                        </div>
