...
<!--                                <br>
                                ...
                                <a href="<?php echo base_url('home/insert_step_2_custom/'.@$this->uri->segment(3).'/'.@$this->uri->segment(4)); ?>"><input type="button" class="btn btn-primary mt-3" value="No EZQC Label?" /></a>
