                                    ...
                                    foreach ($data as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo base_url('search_defect/search_result/'.$row->tract_id.'-'.$row->lot_id.'-1'); ?>" class="theme_color" style="font-size: 20px;"><i class="fa fa-arrow-circle-right"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
