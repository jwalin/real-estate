    ...
    public function excel_import() {
        ...
        if (isset($_FILES["file"]["name"])) {
            ...
            if ($in_systen == 3) {
                ...
                $this->session->set_flashdata('error', 'At least one tract number within the uploaded spreadsheet is missing from Settings > Tracts. Must add the missing tract number to Settings > Tracts before EZQC will allow you to add lots to it.');
            } elseif ($in_systen == 2) {
