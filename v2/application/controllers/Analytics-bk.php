...
class Analytics extends My_Controller {
    ...
    public function index() {
        ...
        $data['avg_defect_count_per_lot'] = round($dcount / $lcount, 2);
        /*-------------------------------------------------------------------------------------------*/
...
//        print_r($datas);exit; 
        ...
        foreach ($complete_defect_tract as $complete_defect_tract){
            ...
            if($incomplete_count_tract == 0){
                ...
                $dayscount_tract = $dayscount_tract + $diff_days_tract->diff_days_count;
                $lotcount_tract++;
            }
        }
        ...
        foreach ($complete_defect_partner as $complete_defect_partner){
            ...
            if($incomplete_count_partner == 0){
                ...
                $dayscount_partner = $dayscount_partner + $diff_days_partner->diff_days_count;
                $lotcount_partner++;
            }
        }
        ...
        $data['total_defect_per_lot_graph_partner'] = $partners_datas;
        /*-------------------------------------------------------------------------------------------*/
        $totat_days_partner = "";
        ...
        $data['total_days_complation_graph_partner'] = $totat_days_partner;
        /*-------------------------------------------------------------------------------------------*/
        /*-------------------------------------------------------------------------------------------*/
...
//            }
        ...
        $data['lot_complation_graph'] = $lot_complation_graph;
        /*-------------------------------------------------------------------------------------------*/
