                            ...
                            <div class="row">
                                <form action="<?php echo base_url('home/insert_review_complete_defect'); ?>" method="post" enctype="multipart/form-data" onsubmit="return validate_form()" style="width: 100%;">
                                    <div class="col-md-12">
                                        ...
                                        <h2 class="theme_color">Quick Add Defect(s) - Step 3</h2><br>
                                        <?php
                                        if (@$this->uri->segment(3) && @$this->uri->segment(4)) {
                                            ?>
                                    ...
                                    <?php if (count($tract_lot_temp_data) != 0) { ?>
                                        <div class="col-md-12" style="clear: both;">
                                            <div class="col-md-12" style="border-top: 2px solid gray;clear: both;">
                                                <a href="<?php echo base_url('home/quick_add_step_1/' . @$this->uri->segment(3) . '/' . @$this->uri->segment(4)); ?>" class="btn btn-primary mt-3" style="color: #fff;" />Add New Defect</a>
												...
												<input type="submit" name="submit_checklists" class="btn btn-primary mt-3" value="Save New Defects" />
