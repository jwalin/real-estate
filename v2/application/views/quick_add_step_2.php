                ...
                <div class="card-body p-20 text-center">
                    ...
                    <div class="col-sm-6 pull-left">
                        <form id="formid" action="<?php echo base_url('home/insert_step_3'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            ?>
                            <fieldset>
                                <h2 class="theme_color">Quick Add Defect(s) - Step 2</h2><br>
                                <?php
                                if (@$this->uri->segment(3) && @$this->uri->segment(4)) {
                                    ?>
                                ...
                                <div class="col-sm-12 clearfix">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="location" name="location" required onchange="location_to_category(this.value)">
...
//        return false;
        ...
        $.ajax({
            url: '<?= base_url() . 'home/ajax_trade_category_partner_new/' ?>',
            data: {tract_id: tract_id, location: location, total: total},
            type: 'post',
...
// category_to_defect(cat, tract_id);
    function category_to_defect(ele, tract_ids='', loc_ids='') {
        var tract_id = $('#tract_id').val();
    ...
    function location_to_category(ele) {
        $.ajax({
            url: '<?= base_url() . 'home/ajax_location_to_category/' ?>',
            data: {loc_id: ele},
            type: 'post',
            success: function (data) {
                // console.log(data);
                ...
                cat = $('#cat').val();
                var tract_id = $('#tract_id').val();
                category_to_defect(cat, tract_id, ele);
            }
        });
    }
