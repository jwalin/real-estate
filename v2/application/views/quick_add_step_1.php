            ...
            <div class="card mb-0">
                <div class="card-body p-3 text-center">
                    ...
                    <div class="col-sm-6 p-0 pull-left">
                        <form action="<?php echo base_url('home/insert_step_2'); ?>" method="post" onsubmit="return validate_form()">
                            ...
                            <fieldset>
                                <h2 class="theme_color">Quick Add Defect(s) - Step 1</h2><br>
                                <?php 
...
<!--                                <br>
                                ...
                                <a href="<?php echo base_url('home/insert_step_2_custom/'.@$this->uri->segment(3).'/'.@$this->uri->segment(4)); ?>"><input type="button" class="btn btn-primary mt-3" value="No EZQC Label?" /></a><br/>
                                <a href="<?php echo base_url('checklists/checklists_dashboard/'.base64_decode(base64_decode(@$this->uri->segment(3))).'/'.base64_decode(base64_decode(@$this->uri->segment(4)))); ?>"><input type="button" class="btn btn-primary mt-3" value="Cancel" /></a>
