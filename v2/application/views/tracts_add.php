                ...
                <div class="card-body">
                    <form action="<?php echo base_url('tracts/insert'); ?>" method="post">
                        ...
                        foreach ($data_category as $row_category){
                            if(@$data_last_tracts->id){
                                $data_cat_partner = $this->tracts_model->get_cat_partner_data_by_tracts(@$data_last_tracts->id, $row_category->id);
                            }
                        ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="partner_id[]">
                                    ...
                                    <option value="<?php echo $row_partner->id; ?>" <?php if(@$row_partner->id == @$data_cat_partner->partner_id){ echo 'selected'; } ?>><?php echo $row_partner->partner_name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
