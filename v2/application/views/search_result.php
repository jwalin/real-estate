...
//                                                        }
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo base_url('search_label/defect_details/' . base64_encode(base64_encode($data->scanner_code)).'/'.$this->uri->segment(3).'/tl'); ?>" class="theme_color" style="font-size: 30px;"><i class="fa fa-arrow-circle-right"></i></a>
