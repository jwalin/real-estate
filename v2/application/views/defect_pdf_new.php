...
<html>
                ...
                <table class="table" style="width: 100%;margin: auto;font-weight: 500;font-size: 10px;color: #000;">
                    <thead>
                        <tr>
							...
							<th colspan="1">
							<?php if(@$lot_n_tract_no!=''){ echo $lot_n_tract_no; } ?>
							</th>
							...
							<th colspan="1">
							CH Items: <?php echo $CH_defect; ?>
							</th>
                                                        
							<th colspan="1">
							Checklist Inspections: <?php echo @$check_ins; ?>
							</th>
    ...
    //                                                        }
                                ...
                                <td class="text-center">
									<?php if($data->closing_hold == 1){ ?>
										<div class="a" style="float: right;">&nbsp; CRITICAL &nbsp;</div>
									<?php } ?>
