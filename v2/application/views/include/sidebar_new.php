    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul class="menu_sidebar">
                ...
                <li class="<?php if ($this->router->fetch_method() == 'defect_list' || $this->router->fetch_method() == 'quick_add_step_1' || $this->router->fetch_method() == 'quick_add_step_2' || $this->router->fetch_method() == 'review_complete_defect_list') { ?> active <?php } ?>"> 
                    <a href="<?php echo base_url('home/quick_add'); ?>"><i class="la la-file-text"></i> <span>Quick Add Defect(s)</span></a>
                </li>
                <?php } } ?>

                <li class="<?php if ($this->router->fetch_class() == 'checklists' || $this->router->fetch_class() == 'Checklists') { ?> active <?php } ?>"> 
                    <a href="<?php echo base_url('checklists'); ?>"><i class="fa fa-check-square-o"></i> <span>Checklists</span></a>
                </li>

                <li class="<?php if ($this->router->fetch_class() == 'search_defect') { ?> active <?php } ?>"> 
                    <a href="<?php echo base_url('search_defect'); ?>"><i class="la la-search"></i> <span>Search by Trade Partner</span></a>
                </li>

                <li class="<?php if ($this->router->fetch_class() == 'search_label') { ?> active <?php } ?>"> 
                    <a href="<?php echo base_url('search_label'); ?>"><i class="la la-search"></i> <span>Search by Defect Code</span></a>
                </li>
