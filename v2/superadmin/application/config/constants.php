...
define('IMG_UPLOAD_PATH', 'https://ezqcapp.com/beta/v2/upload/');
define('LOGO_IMG', 'https://ezqcapp.com/assets/images/logo.jpg');
define('USER_LOGIN_LINK', 'https://ezqcapp.com/beta/login');
